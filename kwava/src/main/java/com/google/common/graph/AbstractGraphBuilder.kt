 ...
 * @author James Sexton
 */
internal abstract class AbstractGraphBuilder<N>
 ...
 */
constructor(val directed: Boolean) {
    var allowsSelfLoops = false
    var nodeOrder = ElementOrder.insertion<N>()
    var expectedNodeCount = Optional.absent<Int>()
}
