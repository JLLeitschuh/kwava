...
public final class ClassPath {
  ...
  public ImmutableSet<ClassInfo> getTopLevelClasses(String packageName) {
    ...
    ImmutableSet.Builder<ClassInfo> builder = ImmutableSet.Companion.builder();
  ...
  abstract static class Scanner {
    ...
    // with.
    private final Set<File> scannedUris = Sets.INSTANCE.newHashSet();
    ...
    static ImmutableSet<File> getClassPathFromManifest(
      ...
      ImmutableSet.Builder<File> builder = ImmutableSet.Companion.builder();
  ...
  static final class DefaultScanner extends Scanner {
    ...
    ImmutableSet<ResourceInfo> getResources() {
      ImmutableSet.Builder<ResourceInfo> builder = ImmutableSet.Companion.builder();
