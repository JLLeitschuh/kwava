...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C>
  ...
  final class AsRanges extends ForwardingCollection<Range<C>> implements Set<Range<C>> {
    ...
    public boolean equals( Object o) {
      return Sets.INSTANCE.equalsImpl(this, o);
    }
  }
  ...
  static final class RangesByUpperBound<C extends Comparable<?>>
    ...
    public NavigableMap<Cut<C>, Range<C>> subMap(
      ...
      return subMap(
          Range.range(
              fromKey, BoundType.Companion.forBoolean(fromInclusive),
              toKey, BoundType.Companion.forBoolean(toInclusive)));
    }

    @Override
    public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> toKey, boolean inclusive) {
      return subMap(Range.upTo(toKey, BoundType.Companion.forBoolean(inclusive)));
    }

    @Override
    public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> fromKey, boolean inclusive) {
      return subMap(Range.downTo(fromKey, BoundType.Companion.forBoolean(inclusive)));
    }
  ...
  private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>>
    ...
    public NavigableMap<Cut<C>, Range<C>> subMap(
      ...
      return subMap(
          Range.range(
              fromKey,
              BoundType.Companion.forBoolean(fromInclusive),
              toKey,
              BoundType.Companion.forBoolean(toInclusive)));
    }
