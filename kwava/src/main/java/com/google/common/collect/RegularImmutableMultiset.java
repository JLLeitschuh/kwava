...
class RegularImmutableMultiset<E> extends ImmutableMultiset<E> {
  ...
  static <E> ImmutableMultiset<E> create(Collection<? extends Entry<? extends E>> entries) {
    ...
    if (distinct == 0) {
      return new RegularImmutableMultiset<>(entryArray, null, 0, 0, ImmutableSet.Companion.of());
    }
    int tableSize = Hashing.INSTANCE.closedTableSize(distinct, MAX_LOAD_FACTOR);
    ...
    for (Entry<? extends E> entry : entries) {
      ...
      int bucket = Hashing.INSTANCE.smear(hash) & mask;
    ...
    return hashFloodingDetected(hashTable)
        ...
        : new RegularImmutableMultiset<E>(
            entryArray, hashTable, Ints.INSTANCE.saturatedCast(size), hashCode, null);
  }
  ...
  public int count( Object element) {
    ...
    int hash = Hashing.INSTANCE.smearedHash(element);
