...
public final class LinkedHashMultimap<K, V>
  ...
  final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
    ...
    ValueSet(K key, int expectedValues) {
      ...
      int tableSize = Hashing.INSTANCE.closedTableSize(expectedValues, VALUE_SET_LOAD_FACTOR);
    ...
    public boolean contains( Object o) {
      int smearedHash = Hashing.INSTANCE.smearedHash(o);
    ...
    public boolean add( V value) {
      int smearedHash = Hashing.INSTANCE.smearedHash(value);
    ...
    private void rehashIfNecessary() {
      if (Hashing.INSTANCE.needsResizing(size, hashTable.length, VALUE_SET_LOAD_FACTOR)) {
        @SuppressWarnings("unchecked")
  ...
  Spliterator<V> valueSpliterator() {
    return CollectSpliterators.INSTANCE.map(entrySpliterator(), Entry::getValue);
  }
