...
public final class Iterables {
  ...
  public static <T> T[] toArray(Iterable<? extends T> iterable, Class<T> type) {
    return toArray(iterable, ObjectArrays.INSTANCE.newArray(type, 0));
  }
  ...
  public static <T> Iterable<T> filter(
    ...
    return new FluentIterable<T>() {
      ...
      @Override
      public Spliterator<T> spliterator() {
        return CollectSpliterators.INSTANCE.filter(unfiltered.spliterator(), retainIfTrue);
      }
    };
  }
  ...
  public static <F, T> Iterable<T> transform(
    ...
    return new FluentIterable<T>() {
      ...
      @Override
      public Spliterator<T> spliterator() {
        return CollectSpliterators.INSTANCE.map(fromIterable.spliterator(), function);
      }
    };
  }
