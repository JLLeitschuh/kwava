...
final class SingletonImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
  ...
  ImmutableSet<Entry<K, V>> createEntrySet() {
    return ImmutableSet.Companion.of(Maps.immutableEntry(singleKey, singleValue));
  }

  @Override
  ImmutableSet<K> createKeySet() {
    return ImmutableSet.Companion.of(singleKey);
  }

  @LazyInit  transient ImmutableBiMap<V, K> inverse;
