...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
  ...
  Spliterator<K> keySpliterator() {
    return CollectSpliterators.INSTANCE.map(entrySet().spliterator(), Entry::getKey);
  }
  ...
  private final class MapViewOfValuesAsSingletonSets
    ...
    public ImmutableSet<V> get( Object key) {
      ...
      return (outerValue == null) ? null : ImmutableSet.Companion.of(outerValue);
    }
        ...
        public Entry<K, ImmutableSet<V>> next() {
          ...
          return new AbstractMapEntry<K, ImmutableSet<V>>() {
            ...
            public ImmutableSet<V> getValue() {
              return ImmutableSet.Companion.of(backingEntry.getValue());
            }
          };
        }
      };
  ...
  @Override
  public int hashCode() {
    return Sets.INSTANCE.hashCodeImpl(entrySet());
  }
