...
public final class Iterators {
  ...
  public static int size(Iterator<?> iterator) {
    ...
    return Ints.INSTANCE.saturatedCast(count);
  }
  ...
  static <T> UnmodifiableListIterator<T> forArray(
    ...
    Preconditions.INSTANCE.checkPositionIndexes(offset, end, array.length);
    Preconditions.INSTANCE.checkPositionIndex(index, length);
    if (length == 0) {
      return emptyListIterator();
    }
