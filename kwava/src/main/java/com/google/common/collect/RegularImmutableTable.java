...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
  ...
  final ImmutableSet<Cell<R, C, V>> createCellSet() {
    return isEmpty() ? ImmutableSet.Companion.<Cell<R, C, V>>of() : new CellSet();
  }
  ...
  private static <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(
    ...
    ImmutableSet<R> rowSpace =
        (rowComparator == null)
            ? ImmutableSet.Companion.copyOf(rowSpaceBuilder)
            : ImmutableSet.Companion.copyOf(ImmutableList.sortedCopyOf(rowComparator, rowSpaceBuilder));
    ImmutableSet<C> columnSpace =
        (columnComparator == null)
            ? ImmutableSet.Companion.copyOf(columnSpaceBuilder)
            : ImmutableSet.Companion.copyOf(ImmutableList.sortedCopyOf(columnComparator, columnSpaceBuilder));
