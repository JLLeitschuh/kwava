...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
  ...
  ContiguousSet<C> headSetImpl(C toElement, boolean inclusive) {
    return intersectionInCurrentDomain(Range.upTo(toElement, BoundType.Companion.forBoolean(inclusive)));
  }
  ...
  ContiguousSet<C> tailSetImpl(C fromElement, boolean inclusive) {
    return intersectionInCurrentDomain(Range.downTo(fromElement, BoundType.Companion.forBoolean(inclusive)));
  }
