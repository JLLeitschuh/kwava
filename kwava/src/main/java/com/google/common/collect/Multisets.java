...
public final class Multisets {
  ...
  private static final class FilteredMultiset<E> extends ViewMultiset<E> {
    ...
    @Override
    Set<E> createElementSet() {
      return Sets.INSTANCE.filter(unfiltered.elementSet(), predicate);
    }
  ...
  public static <E> Multiset<E> union(
    ...
    return new ViewMultiset<E>() {
      ...
      @Override
      Set<E> createElementSet() {
        return Sets.INSTANCE.union(multiset1.elementSet(), multiset2.elementSet());
      }
  ...
  public static <E> Multiset<E> intersection(
    ...
    return new ViewMultiset<E>() {
      ...
      @Override
      Set<E> createElementSet() {
        return Sets.INSTANCE.intersection(multiset1.elementSet(), multiset2.elementSet());
      }
  ...
  static <E> Spliterator<E> spliteratorImpl(Multiset<E> multiset) {
    ...
    return CollectSpliterators.INSTANCE.flatMap(
        entrySpliterator,
  ...
  static int linearTimeSizeImpl(Multiset<?> multiset) {
    ...
    return Ints.INSTANCE.saturatedCast(size);
  }
