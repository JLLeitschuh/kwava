...
public class CycleDetectingLockFactory {
  ...
  private static class LockGraphNode {
    ...
    LockGraphNode(String lockName) {
      this.lockName = Preconditions.INSTANCE.checkNotNull(lockName);
    }
    ...
    void checkAcquiredLock(Policy policy, LockGraphNode acquiredLock) {
      ...
      Preconditions.INSTANCE.checkState(
          this != acquiredLock,
      ...
      Set<LockGraphNode> seen = Sets.INSTANCE.newIdentityHashSet();
  ...
  final class CycleDetectingReentrantLock extends ReentrantLock implements CycleDetectingLock {
    ...
    private CycleDetectingReentrantLock(LockGraphNode lockGraphNode, boolean fair) {
      super(fair);
      this.lockGraphNode = Preconditions.INSTANCE.checkNotNull(lockGraphNode);
    }
