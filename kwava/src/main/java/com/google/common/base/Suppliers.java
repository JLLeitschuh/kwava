...
public final class Suppliers {
  ...
  public static <F, T> Supplier<T> compose(Function<? super F, T> function, Supplier<F> supplier) {
    Preconditions.INSTANCE.checkNotNull(function);
    Preconditions.INSTANCE.checkNotNull(supplier);
  ...
  static class ExpiringMemoizingSupplier<T> implements Supplier<T>, Serializable {
    ...
    ExpiringMemoizingSupplier(Supplier<T> delegate, long duration, TimeUnit unit) {
      ...
      Preconditions.INSTANCE.checkArgument(duration > 0);
    }
  ...
  public static <T> Supplier<T> synchronizedSupplier(Supplier<T> delegate) {
    return new ThreadSafeSupplier<T>(Preconditions.INSTANCE.checkNotNull(delegate));
  }
